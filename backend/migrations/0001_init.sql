...
CREATE TABLE IF NOT EXISTS banners (
  id TEXT PRIMARY KEY, title TEXT NOT NULL, subtitle TEXT, image TEXT NOT NULL, link TEXT, buttonText TEXT,
...
CREATE TABLE IF NOT EXISTS pages (id TEXT PRIMARY KEY, title TEXT NOT NULL, titleEn TEXT, slug TEXT UNIQUE NOT NULL, content TEXT, contentEn TEXT, status TEXT NOT NULL DEFAULT 'published', isActive INTEGER NOT NULL DEFAULT 1, metaTitle TEXT, metaDescription TEXT, sortOrder INTEGER NOT NULL DEFAULT 0, createdAt TEXT NOT NULL, updatedAt TEXT NOT NULL);
...
CREATE TABLE IF NOT EXISTS theme_presets (id TEXT PRIMARY KEY, name TEXT NOT NULL, description TEXT, theme TEXT NOT NULL DEFAULT '{}', isActive INTEGER NOT NULL DEFAULT 0, sortOrder INTEGER NOT NULL DEFAULT 0, createdAt TEXT NOT NULL, updatedAt TEXT NOT NULL);
